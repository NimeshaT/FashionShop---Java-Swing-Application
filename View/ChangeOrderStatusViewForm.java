...
public class ChangeOrderStatusViewForm extends JFrame{
    ...
    public ChangeOrderStatusViewForm(){

        setSize(400,500);
        setTitle("Change Status Form");
        ...
        btnChangeStatus.setFont(new Font("",Font.BOLD,12));
        btnChangeStatus.setBackground(Color.blue);
        btnChangeStatus.setForeground(Color.white);
        btnChangeStatus.setBounds(200,400,150,30);
